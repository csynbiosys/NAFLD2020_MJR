...
ds_path <- "../Data/level5_beta_trt_cp_n720216x12328.gctx" #Upload compounds information
siginfo_matrix <- data.table::fread("../Data/siginfo_beta.txt") #Upload signature information
geneinfo_matrix <- data.table::fread("../Data/geneinfo_beta.txt") #Upload genetic information 
compoundinfo_matrix <- data.table::fread("../Data/compoundinfo_beta.txt") #Upload compound information
