...
NAFLD_scores <- read.csv("./Data/NAFLD_scores_pilot.csv", row.names = 1, stringsAsFactors = FALSE)
...
feature_counts <- read.csv("./Data/featurecounts+coordsorted+gene_pilot.csv", row.names = 1, stringsAsFactors = FALSE)
...
gene_symbols <- read.csv('../Data/Gene_symbols_ensembl.csv', row.names = 1) #Upload the information regarding the gene symbols for each ensembl ID.
...
pdf(file = "./Results/Pheatmap_highexpressed.pdf", width = 13, height = 14)
...
pdf(file = "./Results/HClust_sampledist.pdf")
plot(hclust(sampleDists))
dev.off()
pdf(file = "./Results/Pheatmap_sampledist.pdf", width = 13, height = 14)
...
dev.off()
pdf(file = "./Results/PC1-PC2_LI-HB.pdf", width = 15, height = 14)
...
pdf(file = "./Results/PC2-PC3_fibrosis-steatosis.pdf", width = 15, height = 14)
...
dev.off()
pdf(file = "./Results/PC2-PC3_LI-HB.pdf", width = 15, height = 14)
...
Cirrhosis_results <- dea_edgeR(counts_normalised, group_var = 'Fibrosis_level', blocking_vars = 'Lobular.inflammation', contrast_name = 'Fibrosis_levelFibrosis_high-Fibrosis_levelFibrosis_low')
...
entrez_id <- read.csv('./Data/Entrez_id.txt')
...
write.csv(Cirrhosis_results$results, './Results/Cirrhosis.csv')
top_genes <- Cirrhosis_results$results[1:50,]
pdf('./Results/Cirrhosis_maplot.pdf', width = 15, height = 10)
ma_plot(Cirrhosis_results$results, 2, 0.05)
dev.off()
pdf('./Results/Cirrhosis_pheatmap.pdf', width = 15, height = 10)
...
dev.off()
pdf('./Results/Cirrhosis_volcanoplot.pdf', width = 15, height = 10)
volcano_plot(Cirrhosis_results$results)
dev.off()

##Fibrosis med- fibrosis low
Fibrosis_med_low <- dea_edgeR(counts_normalised, group_var = 'Fibrosis_level', blocking_vars = 'Lobular.inflammation', contrast_name = 'Fibrosis_levelFibrosis_med-Fibrosis_levelFibrosis_low')
...
write.csv(Fibrosis_med_low$results, './Results/Fibrosis_med-low.csv')
top_genes <- Fibrosis_med_low$results[1:50,]
pdf('./Results/Fibrosis_med-low_maplot.pdf', width = 15, height = 10)
ma_plot(Fibrosis_med_low$results, 2, 0.05)
dev.off()
pdf('./Results/Fibrosis_med-low_volcanoplot.pdf', width = 15, height = 10)
volcano_plot(Fibrosis_med_low$results)
dev.off()
pdf('./Results/Fibrosis_med-low_pheatmap.pdf', width = 15, height = 10)
...
##Fibrosis high - med
Fibrosis_high_med <- dea_edgeR(counts_normalised, 'Fibrosis_level', 'Lobular.inflammation', contrast_name = 'Fibrosis_levelFibrosis_high-Fibrosis_levelFibrosis_med')
...
write.csv(Fibrosis_high_med$results, './Results/High-med.csv')
top_genes <- Fibrosis_high_med$results[1:50,]
pdf('./Results/Fibrosis_high-med_maplot.pdf', width = 15, height = 10)
ma_plot(Fibrosis_high_med$results, 2, 0.05)
dev.off()
pdf('./Results/Fibrosis_high-med_volcanoplot.pdf', width = 15, height = 10)
volcano_plot(Fibrosis_high_med$results)
dev.off()
pdf('./Results/Fibrosis_high-med_pheatmap.pdf', width = 15, height = 10)
...
Steatosis <- dea_edgeR(counts_normalised, group_var = 'Steatosis_level', blocking_vars = 'variant', 'Steatosis_levelSteatosis_high-Steatosis_levelSteatosis_low')
...
write.csv(Steatosis$results, './Results/Steatosis.csv')
top_genes <- Steatosis$results[1:50,]
pdf('./Results/Steatosis_maplot.pdf', width = 15, height = 10)
ma_plot(Steatosis$results, 2, 0.05)
dev.off()
pdf('./Results/Steatosis_volcanoplot.pdf', width = 15, height = 10)
volcano_plot(Steatosis$results)
dev.off()
pdf('./Results/Steatosis_pheatmap.pdf', width = 15, height = 10)
...
Hepatocyte_ballooning <- dea_edgeR(counts_normalised, 'HB', contrast_name = 'HBHB_high-HBHB_low')
...
write.csv(Hepatocyte_ballooning$results, './Results/Hepatocyte_ballooning.csv')
top_genes <- Hepatocyte_ballooning$results[1:50,]
pdf('./Results/Hepatocyte_ballooning_maplot.pdf', width = 15, height = 10)
ma_plot(Hepatocyte_ballooning$results, 2, 0.05)
dev.off()
pdf('./Results/Hepatocyte_ballooning_volcanoplot.pdf', width = 15, height = 10)
volcano_plot(Hepatocyte_ballooning$results)
dev.off()
pdf('./Results/Hepatocyte_ballooning_pheatmap.pdf', width = 15, height = 10)
...
Lobular_inflammation <- dea_edgeR(counts_normalised, 'LI', c('Fibrosis', 'variant'), 'LILI_high-LILI_low')
...
write.csv(Lobular_inflammation$results, './Results/Lobular_inflammation.csv')
top_genes <- Lobular_inflammation$results[1:50,]
pdf('./Results/Lobular_inflammation_maplot.pdf', width = 15, height = 10)
ma_plot(Lobular_inflammation$results, 2, 0.05)
dev.off()
pdf('./Results/Lobular_inflammation_pheatmap.pdf', width = 15, height = 10)
...
cirrhosis_path <- pathway_analysis(Cirrhosis_results, go, reactome, kegg, eps = 1e-10, permut = 1000, lv = FALSE)
fib_med_low_path <- pathway_analysis(Fibrosis_med_low, go, reactome, kegg, eps = 1e-10, permut = 1000, lv = FALSE)
fib_high_med_path <- pathway_analysis(Fibrosis_high_med, go, reactome, kegg, eps = 1e-10, permut = 1000, lv = FALSE)
steatosis_path <- pathway_analysis(Steatosis, go, reactome, kegg, eps = 1e-10, permut = 1000, lv = FALSE)
inflammation_path <- pathway_analysis(Lobular_inflammation, go, reactome, kegg, eps = 1e-10, permut = 1000, lv = FALSE)
ballooning_path <- pathway_analysis(Hepatocyte_ballooning, go, reactome, kegg, eps = 1e-10, permut = 1000, lv = FALSE)
